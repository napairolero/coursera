...
As can be seen, the base distribution (exponential) is not normal, but the distribution of the sample mean looks much more normal. By the central limit theorem, this should become more pronounced as the sample size (here n=40) increases. 